export const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://school-backend-black.vercel.app/api';
export const API_IMAGE_URL = import.meta.env.VITE_API_IMAGE_URL || 'https://school-backend-black.vercel.app';
